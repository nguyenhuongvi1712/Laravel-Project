    ...
    <ul id="sidebar-menu">
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?page=list_page" title="" class="nav-link">Danh sách các voucher</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?page=list_customer" title="" class="nav-link">Danh sách đặt bàn</a>
                </li>
                <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?page=list_widget" title="" class="nav-link">Danh sách banner</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?page=list_slider" title="" class="nav-link">Danh sách quảng cáo</a>
                </li>
            </ul>
        </li>
    </ul>
